 ...
 * @version $Id: AbstractFragment.java 1 2016-08-08 10:00:06Z huan.song $
 * @since 1.0
 */
public abstract class AbstractFragment<VM extends AbstractViewModel> extends Fragment {
     ...
     * 视图Id生成器
     */
    private final static AtomicInteger sViewCounter = new AtomicInteger(0);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUniqueLoaderIdentifier = (savedInstanceState == null) ? sViewCounter.incrementAndGet() : savedInstanceState.getInt(LOADER_ID_SAVED_STATE);

        Logger.d(TAG, getFragmentName() + "::onCreate() loader identifier: " + mUniqueLoaderIdentifier + ", fragment layout id: " + getFragmentLayoutId());
        injectDependencies();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Logger.d(TAG, getFragmentName() + "::onCreateView()");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Logger.d(TAG, getFragmentName() + "::onViewCreated()");
    ...
    public void onDestroyView() {
        Logger.d(TAG, getFragmentName() + "::onDestroyView()");
    ...
    public void onViewModelCreated() {
        Logger.d(TAG, getFragmentName() + "::onViewModelCreated()");
    ...
    protected void injectDependencies() {
        try {
            ...
            Logger.e(TAG, getFragmentName() + "::injectDependencies()", e);
        }
    ...
    public void onStart() {
        ...
        Logger.d(TAG, getFragmentName() + "::onStart()");
    ...
    @Override
    public void onStop() {
        Logger.d(TAG, getFragmentName() + "::onStop()");
    ...
    protected void processViewModelInject() throws IllegalArgumentException {
        ...
        try {
            ...
            Logger.e(TAG, "process failure", e);
