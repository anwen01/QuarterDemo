 ...
 * @version $Id: FragmentHelper.java 1 2016-08-10 15:00:06Z huan.song $
 * @since 1.0
 */
public class FragmentHelper {
    ...
    public boolean batchAdd(Map<Integer, Fragment> fragments) throws NullPointerException, IllegalStateException {
        if (fragments == null) {
            Logger.e(TAG, "batchAdd, activity name: " + getActivityName() + ", fragments is null");
            throw new NullPointerException("fragments is null");
        }

        if (fragments.isEmpty()) {
            Logger.e(TAG, "batchAdd, activity name: " + getActivityName() + ", fragments is empty");
            return false;
        }
        ...
        for (Map.Entry<Integer, Fragment> entry : fragments.entrySet()) {
            ...
            Logger.d(TAG, "batchAdd activity name: " + getActivityName() + ", container view id: " + containerViewId);
        ...
        try {
            ...
            Logger.d(TAG, "batchAdd activity name: " + getActivityName() + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "batchAdd activity name: " + getActivityName(), e);
            return false;
        }
    ...
    public boolean add(@IdRes int containerViewId, Fragment fragment) throws IllegalStateException {
        ...
        try {
            ...
            Logger.d(TAG, "add activity name: " + getActivityName() + ", container view id: " + containerViewId + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "add activity name: " + getActivityName() + ", container view id: " + containerViewId, e);
            return false;
        }
    ...
    public boolean batchReplace(Map<Integer, Fragment> fragments) throws NullPointerException, IllegalStateException {
        if (fragments == null) {
            Logger.e(TAG, "batchReplace, activity name: " + getActivityName() + ", fragments is null");
            throw new NullPointerException("fragments is null");
        }

        if (fragments.isEmpty()) {
            Logger.e(TAG, "batchReplace, activity name: " + getActivityName() + ", fragments is empty");
            return false;
        }
        ...
        for (Map.Entry<Integer, Fragment> entry : fragments.entrySet()) {
            int containerViewId = entry.getKey();
            Fragment fragment = entry.getValue();
            Logger.d(TAG, "batchReplace activity name: " + getActivityName() + ", container view id: " + containerViewId);
        ...
        try {
            int identifier = transaction.addToBackStack(null).commit();
            Logger.d(TAG, "batchReplace activity name: " + getActivityName() + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "batchReplace activity name: " + getActivityName(), e);
            return false;
        }
    ...
    public boolean replace(@IdRes int containerViewId, Fragment fragment) throws IllegalStateException {
        ...
        try {
            int identifier = transaction.commit();
            Logger.d(TAG, "replace activity name: " + getActivityName() + ", container view id: " + containerViewId + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "replace activity name: " + getActivityName() + ", container view id: " + containerViewId, e);
            return false;
        }
    ...
    public boolean remove(Fragment fragment) {
        try {
            ...
            Logger.d(TAG, "remove activity name: " + getActivityName() + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "remove activity name: " + getActivityName(), e);
            return false;
        }
    ...
    public boolean show(Fragment fragment) {
        try {
            ...
            Logger.d(TAG, "show activity name: " + getActivityName() + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "show activity name: " + getActivityName(), e);
            return false;
        }
    ...
    public boolean hide(Fragment fragment) {
        try {
            ...
            Logger.d(TAG, "hide activity name: " + getActivityName() + ", transaction id: " + identifier);
        } catch (IllegalStateException e) {
            Logger.e(TAG, "hide activity name: " + getActivityName(), e);
            return false;
        }
