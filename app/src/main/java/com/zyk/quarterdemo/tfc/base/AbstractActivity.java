...
import com.zyk.quarterdemo.tfc.util.FragmentHelper;
 ...
 * @version $Id: AbstractActivity.java 1 2016-08-08 10:00:06Z huan.song $
 * @since 1.0
 */
public abstract class AbstractActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::onCreate()");

        if (preContentView()) {
            Logger.d(TAG, mFragmentHelper.getActivityName() + "::onCreate() setContentView, activity layout id: " + getActivityLayoutId());
    ...
    public void onBackPressed() {
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::onBackPressed()");
    ...
    protected boolean preContentView() {
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::preContentView()");
        return true;
    }
    ...
    protected void run() {
        ...
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::run()");
    ...
    protected boolean preRun() {
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::preRun()");
        return true;
    }
    ...
    protected void postRun() {
        Logger.d(TAG, mFragmentHelper.getActivityName() + "::postRun()");
    }
