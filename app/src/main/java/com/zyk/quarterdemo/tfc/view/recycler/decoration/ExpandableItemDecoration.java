...
package com.zyk.quarterdemo.tfc.view.recycler.decoration;
 ...
 * @version $Id: ExpandableItemDecoration.java 1 2017-03-10 14:56:06Z huan.song $
 * @since 1.0
 */
public class ExpandableItemDecoration extends LinearItemDecoration {
    ...
    public static class Builder {
         ...
         *
         * @return a ExpandableItemDecoration
         */
         ...
         *
         * @param decoration a ExpandableItemDecoration
         */
        ...
        public Builder setWidth(int width) {
            if (width >= 0 || width == MATCH_PARENT) {
                ...
                Logger.e(TAG, "Builder setWidth width '" + width + "' is wrong, must be >= 0 or ExpandableItemDecoration.MATCH_PARENT");
            }
        ...
        public Builder setHeight(int height) {
            if (height >= 0) {
                ...
                Logger.e(TAG, "Builder setHeight height '" + height + "' is wrong, must be >= 0");
            }
        ...
        public Builder setMarginLeft(int marginLeft) {
            if (marginLeft >= 0) {
                ...
                Logger.e(TAG, "Builder setMarginLeft marginLeft '" + marginLeft + "' is wrong, must be >= 0");
            }
        ...
        public Builder setMarginTop(int marginTop) {
            if (marginTop >= 0) {
                ...
                Logger.e(TAG, "Builder setMarginTop marginTop '" + marginTop + "' is wrong, must be >= 0");
            }
        ...
        public Builder setMarginBottom(int marginBottom) {
            if (marginBottom >= 0) {
                ...
                Logger.e(TAG, "Builder setMarginBottom marginBottom '" + marginBottom + "' is wrong, must be >= 0");
            }
        ...
        public Builder setTextSize(float size) {
            if (size > 0) {
                ...
                Logger.e(TAG, "Builder setTextSize size '" + size + "' is wrong, must be > 0");
            }
        ...
        public Builder setTextMarginLeft(int marginLeft) {
            if (marginLeft >= 0 || marginLeft == CENTER_HORIZONTAL) {
                ...
                Logger.e(TAG, "Builder setTextMarginLeft marginLeft '" + marginLeft + "' is wrong, must be >= 0 or ExpandableItemDecoration.CENTER_HORIZONTAL");
            }
        ...
        public Builder setTextMarginBottom(int marginBottom) {
            if (marginBottom >= 0 || marginBottom == CENTER_VERTICAL) {
                ...
                Logger.e(TAG, "Builder setTextMarginBottom marginBottom '" + marginBottom + "' is wrong, must be >= 0 or ExpandableItemDecoration.CENTER_VERTICAL");
            }
